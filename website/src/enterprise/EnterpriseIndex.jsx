        ...
        <section className="pt-[48px] pb-[24px] md:pt-[72px]">
          <div className="container-site" style={{ maxWidth: 880 }}>
            ...
            <Motion.p
              ...
              style={{ maxWidth: "66ch" }}
            >
              If your meetings contain confidential data, you can't send the audio to a third party.
              Steno records, transcribes, and summarizes entirely on the device — no cloud, no bot, no
              vendor in your data path. Here's what that means for regulated and sensitive work.
            </Motion.p>
          </div>
        </section>
                ...
                >
                  <div className="flex items-center justify-between gap-5 py-7">
                    <div>
                      ...
                      <span className="block text-fg-2 text-[15px] leading-[1.6] mt-2" style={{ maxWidth: "62ch" }}>
                        {c.intro}
                      </span>
                    </div>
                    <ArrowRight
