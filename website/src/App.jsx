  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 text-slate-100">
      ...
      <section id="features" className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        <div className="flex items-center justify-center gap-8 md:gap-12 flex-wrap mb-12 opacity-40">
          <img src="/llama-text.svg" alt="Meta Llama" className="h-5 md:h-6" />
          <img src="/gemma-text.svg" alt="Google Gemma" className="h-5 md:h-6" />
          <img src="/qwen-text.svg" alt="Qwen" className="h-5 md:h-6" />
          <img src="/deepseek-text.svg" alt="DeepSeek" className="h-5 md:h-6" />
        </div>
