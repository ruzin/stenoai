...
const faqs = [
  ...
  { q: "Does Steno help with HIPAA, GDPR, or SOC 2 compliance?", a: "Steno processes and stores everything on your device, so there's no third-party processor in your data path — which is what regimes like HIPAA and GDPR are fundamentally concerned with, and it keeps data in your jurisdiction. We don't claim to be a 'certified' service, because there's no cloud service to certify. SOC 2, for example, audits a cloud vendor's security controls; Steno has no cloud, so the vendor-breach risk it exists to assure against simply isn't in the picture. Because the source is open, your security team can verify all of this directly. See the industry pages under Enterprise for government, defense, legal, healthcare, and finance specifics." },
