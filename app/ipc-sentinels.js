...
// app/renderer/.../MeetingDetail.tsx), so every producer must agree on the
// literal — a typo here would silently break the corresponding handling. The
// renderer can't require this CJS module (it is bundled separately and only
// includes src/**), so it keeps its own named constant. This module is the
// source of truth for the literal; keep all three (here, e2e-mock, renderer)
// in sync.
