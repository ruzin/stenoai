...
No. The Steno app has no analytics, crash reporting, or usage tracking. (The Steno documentation site uses PostHog for anonymous visitor counts -- this is separate from the app.)
</Accordion>
