...
No. Steno processes all recordings using AI models that run locally on your Mac. No audio, transcript, or summary is transmitted to any external server (unless you opt into a cloud summarization model). The app also sends anonymous usage analytics by default -- see the telemetry question below.
</Accordion>
