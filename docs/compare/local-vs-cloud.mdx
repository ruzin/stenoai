...
Steno transcribes on-device with two engines: Parakeet (the default) and Whisper (optional, selected in **Settings → Transcribe**). Accuracy is high across common recording conditions. Parakeet covers English + 25 European languages and produces a live transcript while you record; switch to Whisper when you need one of its 99 supported languages.
