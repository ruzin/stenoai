...
<Warning>
Steno is not certified under HIPAA, SOC 2, or any other compliance framework. It does not make compliance claims. If you work in a regulated environment, consult your compliance team before using any recording tool -- including Steno. The value Steno provides is technical: no data leaves your device.
</Warning>
