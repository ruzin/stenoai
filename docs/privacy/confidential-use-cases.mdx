...
Steno was built for professionals who work with audio they cannot send to a cloud service. Because all transcription and summarization runs on-device, it is suitable for contexts where confidentiality is a hard requirement.
