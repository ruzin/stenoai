...
description: "After transcription, Steno generates structured meeting notes: a summary paragraph, key topics, key points, and action items -- from a local model by default, or a configured cloud model."
---
