...
**New**
- **Cloud transcription** — Transcribe with any OpenAI-compatible speech-to-text endpoint alongside on-device Parakeet and Whisper. Your API key is stored encrypted on your device, never in plain config.
