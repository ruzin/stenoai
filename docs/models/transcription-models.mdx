...
|--------|-------|------|-------|
| **Parakeet** (default) | `mlx-community/parakeet-tdt-0.6b-v3` | ~572MB | Live transcript while recording; English + 25 European languages |
...
- **Parakeet (default)** transcribes English and 25 other European languages, including French, German, Spanish, Italian, Portuguese, Dutch, Russian, and Polish. A curated subset of six (English, French, German, Spanish, Dutch, Portuguese) can be pinned as the summary output language.
...
- **Switch to Whisper for non-European languages** -- Parakeet covers English and 25 European languages; Whisper covers the full 99-language set

---

<Accordion title="Which engine should I start with?">
Start with **Parakeet** (the default). It runs on-device, shows a live transcript while you record, and covers English plus 25 European languages. Switch to **Whisper** in **Settings → Transcribe** if you need a language outside Parakeet's set.
</Accordion>
...
Yes. Parakeet covers English and 25 European languages (French, German, Spanish, Italian, Dutch, Portuguese, Russian, Polish, and others). For other languages -- including Japanese, Chinese, Korean, Hindi, and Arabic -- switch to the Whisper engine, which covers all 99 languages.
</Accordion>
